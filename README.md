...
Usamos pytyhon 3.10, necesario correr crear un entorno virtual e instalar las dependencias con el comando `pip install -r requirements.txt` para poder correr la app. Luego, para correr la app, usar el comando `streamlit run app.py` y se abrirá una ventana en el navegador con la app.